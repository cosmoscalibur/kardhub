//! Lightweight WASM bridge for the KardHub browser extension.
//!
//! Exposes `kardhub-core` mapping and classification logic as
...
pub fn map_cards_json(raw_json: &str, owner: &str, repo: &str) -> String {
    ...
    // Preserve avatar URLs from raw API (kardhub-core only stores login strings)
